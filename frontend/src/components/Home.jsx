...
function DemoPageContent({ activeSegment, user }) {
  ...
  switch (activeSegment) {
    ...
    default:
      content = (
        <Typography variant="h6">Select a segment to view content.</Typography>
      );
  }
        ...
        {NAVIGATION.map((item) => (
          <Box
            ...
            sx={{
              ...
              backgroundColor:
                activeSegment === item.segment ? "#4259c1" : "transparent", // Light blue for active segment
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {activeSegment.charAt(0).toUpperCase() +
              activeSegment.slice(1).replace("-", " ")}{" "}
            {/* Display selected segment name */}
          </Typography>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Typography
                variant="body1"
                sx={{ marginRight: 2, marginLeft: 3, color: "#134B70" }}
              >
